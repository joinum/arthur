...
import screenshotOffers from '@/images/screenshots/offers.png'
import screenshotOffer from '@/images/screenshots/offer.png'
import screenshotCandidate from '@/images/screenshots/candidate.png'
import screenshotCompany from '@/images/screenshots/company.png'
...
const features = [
  ...
  {
    title: 'Boost your company profile',
    description:
      "Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam.",
    image: screenshotCompany,
  },
]
                    ...
                    <div
                      ...
                      className={clsx(
                        ...
                        selectedIndex === featureIndex
                          ? 'bg-tertiary lg:bg-white/10 lg:ring-1 lg:ring-inset lg:ring-white/10'
